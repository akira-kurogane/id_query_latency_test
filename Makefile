...
id_query_loop_test:	id_query_loop_test.c id_query_loop_test_opts.c
	gcc -c -g id_query_loop_test_opts.c
	gcc -c -g id_query_loop_test.c ${libmongoc_flags}
	gcc -g -o id_query_loop_test id_query_loop_test.o id_query_loop_test_opts.o ${libmongoc_flags}
